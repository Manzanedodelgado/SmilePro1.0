...
const DataInput: React.FC = () => (
    <div className="w-6 h-5 bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-sm flex items-center justify-center text-xs text-gray-400">
        ...
    </div>
);

const MetricRow: React.FC<{ label: string, reversed?: boolean }> = ({ label, reversed }) => (
    <div className={`flex items-center gap-2 text-xs ${reversed ? 'flex-row-reverse' : ''}`}>
