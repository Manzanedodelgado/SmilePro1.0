...
const AlertasPanel: React.FC<AlertasPanelProps> = ({ initialAlerts, onAlertsChange, showToast }) => {
    ...
    return (
        <div className="bg-surface-light dark:bg-surface-dark rounded-lg shadow-sm border border-border-light dark:border-border-dark">
            <div className="bg-red-500/10 dark:bg-red-500/20 p-3 flex justify-between items-center border-b border-red-500/20 dark:border-red-500/30">
                <h3 className="font-bold text-red-600 dark:text-red-300 flex items-center gap-2">
            ...
            <div className="p-4 space-y-4">
                ...
                <button 
                    ...
                    className="w-full bg-blue-700 hover:bg-blue-800-dark text-white font-semibold py-2.5 rounded-md transition-colors shadow flex items-center justify-center gap-2 mt-2"
                >
