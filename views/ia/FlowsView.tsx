...
const FlowCard: React.FC<{ flow: Flow }> = ({ flow }) => (
    <div className="bg-white rounded-2xl border border-blue-200 shadow-sm overflow-hidden">
        <div className="px-4 py-3 flex items-center gap-2.5" style={{ borderBottom: `3px solid ${flow.color}` }}>
            ...
            <div>
                <p className="text-[12px] font-black text-slate-900">{flow.name}</p>
                <p className="text-[10px] text-slate-400">▶ {flow.trigger}</p>
            </div>
        </div>
                    ...
                    <div key={i} className="flex flex-col items-start">
                        <div className="flex items-start gap-2.5 w-full">
                            ...
                            <div className="flex-1 pt-0.5">
                                <p className="text-[11px] font-black text-slate-900 leading-tight">{s.label}</p>
